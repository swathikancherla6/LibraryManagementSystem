...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleAccessDenied(AccessDeniedException ex) {
        ...
        log.warn("Access denied for user='{}' authorities={} : {}",
                auth != null ? auth.getName() : "anonymous",
                auth != null ? auth.getAuthorities() : "none",
                ex.getMessage());
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiResponse.error("Access denied", List.of("You do not have permission to perform this action")));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleGeneral(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiResponse.error("Internal server error", List.of("An unexpected error occurred")));
    }
}
